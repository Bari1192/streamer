...
function __VLS_template() {
    ...
    /** @type { [typeof __VLS_components.RouterLink, typeof __VLS_components.RouterLink, ] } */
    // @ts-ignore
    var __VLS_7 = __VLS_asFunctionalComponent(__VLS_6, new __VLS_6({ to: ("/about"), }));
    var __VLS_8 = __VLS_7.apply(void 0, __spreadArray([{ to: ("/about"), }], __VLS_functionalComponentArgsRest(__VLS_7), false));
